...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__header_login_login_component__ = __webpack_require__("../../../../../src/app/header/login/login.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    {
        path: 'brands',
        component: __WEBPACK_IMPORTED_MODULE_10__brands_brands_component__["a" /* BrandsComponent */],
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_13__header_login_login_component__["a" /* LoginComponent */]
            ],
            imports: [
...
module.exports = "<h1>Product Brands</h1>\n\n<div>\n   <ul>\n      <li *ngFor=\"let brand of brands\">\n         <a routerLink=\"/brand/{{brand._id}}\">{{brand._id}}</a>\n      </li>\n   </ul>\n</div>"
...
var BrandsComponent = (function () {
    ...
    BrandsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('/product/getbrands').subscribe(function (data) {
            _this.brands = data;
        });
    };
